...
export const CHATBOT_MESSAGES = {
  welcome: `👋 Welcome to ${CHATBOT_CONFIG.university} Chatbot! I'm here to help you with information about our programs, admissions, placements, campus facilities, and more. What would you like to know about ${CHATBOT_CONFIG.university}?`,
  ...
  noMatch: "I couldn't find this information. Please contact us at +91 89 8000 4325 or info@raiuniversity.edu for more details.",
...
export const CHATBOT_SETTINGS = {
  searchThreshold: 0.3,
  minPrefixLength: 5, // Increased from 3 to reduce false positives
  maxHistoryDisplay: 50,
  typingDelay: 800,
  minQuestionMatchScore: 0.7, // 70% word match required
};
